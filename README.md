...
## How to Use it
You can follow the deployed link: https://pperfect.herokuapp.com/ . A new user has to sign in and provide their email address and set a password for the application. After logging in, it will take you to the homepage where you will have access to pitches in different categories. You can also add your pitch by creating a new one. 
